-- Make the push trigger URL configurable so the same database can target dev
-- and production backends without code changes.
...
-- Comment documents how to point the trigger at the production host.
