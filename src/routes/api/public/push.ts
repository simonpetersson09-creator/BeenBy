...
const REMINDERS: Record<string, Record<string, string>> = {
  sv: { birthday: "🎂 Födelsedag idag", doctor: "🩺 Läkartid idag", medicine: "💊 Medicin idag", other: "📌 Händelse idag", body: "Öppna BeenBy för att se detaljer." },
  en: { birthday: "🎂 Birthday today", doctor: "🩺 Doctor's appointment today", medicine: "💊 Medicine today", other: "📌 Event today", body: "Open BeenBy to see details." },
  de: { birthday: "🎂 Geburtstag heute", doctor: "🩺 Arzttermin heute", medicine: "💊 Medikament heute", other: "📌 Termin heute", body: "Öffne BeenBy für Details." },
  da: { birthday: "🎂 Fødselsdag i dag", doctor: "🩺 Lægetid i dag", medicine: "💊 Medicin i dag", other: "📌 Begivenhed i dag", body: "Åbn BeenBy for detaljer." },
  nb: { birthday: "🎂 Bursdag i dag", doctor: "🩺 Legetime i dag", medicine: "💊 Medisin i dag", other: "📌 Hendelse i dag", body: "Åpne BeenBy for detaljer." },
  fi: { birthday: "🎂 Syntymäpäivä tänään", doctor: "🩺 Lääkäriaika tänään", medicine: "💊 Lääke tänään", other: "📌 Tapahtuma tänään", body: "Avaa BeenBy nähdäksesi tiedot." },
  nl: { birthday: "🎂 Verjaardag vandaag", doctor: "🩺 Doktersafspraak vandaag", medicine: "💊 Medicijn vandaag", other: "📌 Afspraak vandaag", body: "Open BeenBy voor details." },
  es: { birthday: "🎂 Cumpleaños hoy", doctor: "🩺 Cita médica hoy", medicine: "💊 Medicina hoy", other: "📌 Evento hoy", body: "Abre BeenBy para ver los detalles." },
  fr: { birthday: "🎂 Anniversaire aujourd'hui", doctor: "🩺 Rendez-vous médical aujourd'hui", medicine: "💊 Médicament aujourd'hui", other: "📌 Événement aujourd'hui", body: "Ouvrez BeenBy pour voir les détails." },
  it: { birthday: "🎂 Compleanno oggi", doctor: "🩺 Visita medica oggi", medicine: "💊 Medicina oggi", other: "📌 Evento oggi", body: "Apri BeenBy per i dettagli." },
  pl: { birthday: "🎂 Urodziny dziś", doctor: "🩺 Wizyta u lekarza dziś", medicine: "💊 Leki dziś", other: "📌 Wydarzenie dziś", body: "Otwórz BeenBy, aby zobaczyć szczegóły." },
  pt: { birthday: "🎂 Aniversário hoje", doctor: "🩺 Consulta médica hoje", medicine: "💊 Medicamento hoje", other: "📌 Evento hoje", body: "Abra o BeenBy para ver os detalhes." },
  tr: { birthday: "🎂 Bugün doğum günü", doctor: "🩺 Bugün doktor randevusu", medicine: "💊 Bugün ilaç", other: "📌 Bugün etkinlik", body: "Ayrıntılar için BeenBy'ı açın." },
  ar: { birthday: "🎂 عيد ميلاد اليوم", doctor: "🩺 موعد طبيب اليوم", medicine: "💊 دواء اليوم", other: "📌 حدث اليوم", body: "افتح BeenBy لرؤية التفاصيل." },
};
