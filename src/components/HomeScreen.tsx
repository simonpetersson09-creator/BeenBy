...
import { CalendarDays, CloudOff, Loader2, Lock, MapPinCheckInside, MessageCircle, Plus, RefreshCw, Settings, Share2 } from "lucide-react";
...
export function HomeScreen({
  ...
  return (
    <div className="app-scroll mx-auto h-dvh w-full max-w-md px-5 pb-40 pt-8">
      ...
      <section className="mt-4 rounded-2xl bg-card px-3.5 py-2.5 shadow-soft">
        {nextPlanned ? (
          (() => {
            ...
            return (
              <div className="flex items-center gap-2.5">
                <div
                  className="flex size-9 shrink-0 items-center justify-center rounded-xl text-white shadow-[inset_0_1px_2px_rgba(0,0,0,0.2)]"
                ...
                <div className="min-w-0 flex-1">
                  <p className="flex items-center gap-1 text-[0.6rem] font-medium uppercase tracking-wider text-muted-foreground">
